                    ...
                    <ul class="pro-cat-list"> 
                        ...
                        foreach ($categories as $category) {
                            if ($category->name == "Popular") {
                                ...
                                ?> 
                                <li> 
                                    <a href="<?php echo get_term_link($category->term_id); ?>" data-cta="pro_cat_<?php echo $i; ?>"><?php echo $category->name; ?></a>
                                </li>
                                <?php
                            }
                            $i++;
                                ...
                                <li id="pro_cat_<?php echo $j; ?>"> 
                                    ...
                                    <div class="row">
                                        <?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>   
                                                ...
                                                <div class="col-md-4 col-sm-6 col-xs-6 wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="<?php echo $delayTime; ?>ms" >
